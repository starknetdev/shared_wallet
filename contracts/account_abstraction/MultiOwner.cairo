...
@storage_var
func Account_public_keys(index: felt) -> (res: felt):
end
...
func constructor{
    ...
    Account_initializers(
        index=0,
        public_keys_len=public_keys_len,
...
func Account_initializers{
    ...
    if public_keys_len == index:
        return ()
    end

    Account_public_keys.write(index, public_keys[index])
